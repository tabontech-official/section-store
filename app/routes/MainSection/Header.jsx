...
// export default function PromoBanner({onCategorySelect} ) {
          ...
          {iconItems.map((item, index) => (
            <div
              ...
              style={{
                ...
                padding: "6px 10px",
                borderRadius: "6px",
                border: activeIndex === index ? "1px solid #008060" : "1px solid transparent",
                background: activeIndex === index ? "#eaf5f0" : "transparent",
                color: activeIndex === index ? "#008060" : "#292929ff",
              }}
            >
              <div style={{ marginBottom: "4px" }}>{item.icon}</div>
              <div>{item.label}</div>
