              ...
              <div style={{ borderTop: "1px solid #E3E3E3" }}>
                ...
                <Collapsible open={openCollapse}>
                  <BlockStack gap="100" style={{ padding: "0 16px 16px 16px" }}>
                    <Text tone="subdued">
                      1. First, go to your <strong>Shopify Admin</strong>{" "}
                      dashboard.
                      <br />
                      2. Inside our app, go to the <strong>
                        My Section
                      </strong>{" "}
                      tab, choose a section, and click{" "}
                      <strong>Add to Theme</strong>.
                      <br />
                      3. Now go to{" "}
                      <strong>Online Store → Themes → Customize</strong>.
                      <br />
                      4. In the left sidebar, open <strong>
                        App embeds
                      </strong>{" "}
                      and enable
                      <strong> Sectify - AI Theme Builder</strong>.
                      <br />
                      5. From the sidebar, click <strong>
                        Add section
                      </strong>{" "}
                      and select the section you just pushed from the app.
                      <br />
                      6. Customize it as needed, then click{" "}
                      <strong>Save</strong>.
                      <br />
                    </Text>
                  </BlockStack>
