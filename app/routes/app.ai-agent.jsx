...
const [isFullPageMode, setIsFullPageMode] = useState(false);
  ...
  setIsFullPageMode(isPageIntent);
    ...
    // 🔁 Automatically add matched sections to page (no duplicates)
  ...
  return (
    <Page title="Shopify AI Assistant">
      <Layout>
        <Layout.Section>
          <Card padding="0">
            <Scrollable style={{ height: "400px", padding: "20px 24px" }} shadow>
                ...
                {messages.map((msg, idx) => (
                  <div
                    ...
                    style={{
                      ...
                      maxWidth: "75%",
                      backgroundColor: msg.sender === "user" ? "#e0f7da" : "#ffffff",
              ...
              {matchedSections.length > 0 && (
                <div style={{ marginTop: "28px" }}>
                  <Text variant="headingSm" as="h3" style={{ marginBottom: "16px" }}>
                    Suggested Sections
                  </Text>
                      ...
                      <Card key={idx} padding="400" sectioned>
                        <div style={{ display: "flex", gap: "16px", flexWrap: "wrap" }}>
                          <div style={{ flexShrink: 0 }}>
                            <Thumbnail source={item.media} size="large" alt={item.title} />
                          </div>
        ...
        >
          <Modal.Section>
            <div style={{ display: "flex", gap: "20px", flexWrap: "wrap" }}>
              <Thumbnail source={previewData.media} size="large" alt={previewData.title} />
              <div>
  ...
  {fullPreviewOpen && (
    ...
    >
      <Modal.Section>
        ...
        >
          {/* LEFT: Editor */}
          <div style={{ flex: 1, maxHeight: "70vh", overflowY: "auto", paddingRight: 8 }}>
            {pageSections.map((section, idx) => (
              <Card key={idx} sectioned>
                ...
                <div style={{ marginTop: "12px" }}>
                  <Thumbnail source={section.media} alt={section.title} size="large" />
                </div>
